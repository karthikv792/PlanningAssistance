(define
	...
	(:predicates
		...
		( EXPLAINED_ALERT_FIRECHIEF_MESAFIRE_1 )
		( EXPLAINED_DEPLOY_BIG_ENGINES_FIRECHIEF_MESAFIRE_BYENG_1 )
		( EXPLAINED_CONTACT_MEDIA_FIRECHIEF_1 )
		( EXPLAINED_ALERT_MEDICHIEF_ADMINFIRE_1 )
		...
		( EXPLAINED_ALERT_FIRECHIEF_PHXFIRE_1 )
		( EXPLAINED_DEPLOY_BULLDOZERS_FIRECHIEF_PHXFIRE_BYENG_1 )
	...
	(:action EXPLAIN_OBS_ALERT_FIRECHIEF_MESAFIRE_1
		:parameters ()
		:precondition
		(and
		)
		...
		(and
			...
			( ALERTED_MESAFIRE )
			 ( EXPLAINED_ALERT_FIRECHIEF_MESAFIRE_1 )
			 (not ( NOT_EXPLAINED_ALERT_FIRECHIEF_MESAFIRE_1 ))
		)
	)
	(:action EXPLAIN_OBS_DEPLOY_BIG_ENGINES_FIRECHIEF_MESAFIRE_BYENG_1
		:parameters ()
		:precondition
		(and
			( ALERTED_MESAFIRE )
		...
		(and
			...
			(not ( HAS_BIG_ENGINES_NUMBER_MESAFIRE ))
			 (not ( NOT_EXPLAINED_DEPLOY_BIG_ENGINES_FIRECHIEF_MESAFIRE_BYENG_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_ALERT_MEDICHIEF_ADMINFIRE_1
		:parameters ()
		:precondition
		(and
			( EXPLAINED_CONTACT_MEDIA_FIRECHIEF_1 )
		...
		(and
			...
			( ALERTED_ADMINFIRE )
			 ( EXPLAINED_ALERT_MEDICHIEF_ADMINFIRE_1 )
			 (not ( NOT_EXPLAINED_ALERT_MEDICHIEF_ADMINFIRE_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_ALERT_FIRECHIEF_PHXFIRE_1
		:parameters ()
		:precondition
		(and
			( EXPLAINED_DEPLOY_RESCUERS_FIRECHIEF_ADMINFIRE_BYENG_1 )
		...
		(and
			...
			( ALERTED_PHXFIRE )
			 ( EXPLAINED_ALERT_FIRECHIEF_PHXFIRE_1 )
			 (not ( NOT_EXPLAINED_ALERT_FIRECHIEF_PHXFIRE_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_DEPLOY_BULLDOZERS_FIRECHIEF_PHXFIRE_BYENG_1
		:parameters ()
		:precondition
		(and
			( ALERTED_PHXFIRE )
		...
		(and
			...
			(not ( HAS_BULLDOZERS_NUMBER_PHXFIRE ))
			 (not ( NOT_EXPLAINED_DEPLOY_BULLDOZERS_FIRECHIEF_PHXFIRE_BYENG_1 ))
		)
	)
